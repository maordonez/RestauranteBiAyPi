 ...
 * @author miuguel
 */
public class ContenedorCocinero extends javax.swing.JFrame {

    /**
     * Creates new form Contenedor
     */
    public ContenedorCocinero() {
        initComponents();
        ManagerPrincipal.setDesktopPane(desktopPane);
        lblperfil.setText("COCINERO : "+ManagerPrincipal.getControlador().consultarNombres());
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        ConsultarPedidosCocinero ventana = new ConsultarPedidosCocinero();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContenedorCocinero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContenedorCocinero().setVisible(true);
            }
        });
    }
