...
import co.edu.ufps.vistas.pedidos.ConsultarPedidosCliente;
 ...
 * @author miuguel
 */
public class ContenedorCliente extends javax.swing.JFrame {
    ...
    public ContenedorCliente() {
        ...
        lblperfil.setText("Cliente Invitado");
        setTitle("Menu principal cliente");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        ConsultarPedidosCliente ventana = new ConsultarPedidosCliente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContenedorCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContenedorCliente().setVisible(true);
            }
        });
    }
